package edu.hust.xzf.jdt.tree.hash;

import static edu.hust.xzf.jdt.tree.hash.HashUtils.BASE;
import static edu.hust.xzf.jdt.tree.hash.HashUtils.fpow;
import static edu.hust.xzf.jdt.tree.hash.HashUtils.md5;

import java.util.HashMap;
import java.util.Map;

import edu.hust.xzf.jdt.tree.ITree;
import edu.hust.xzf.jdt.tree.hash.HashUtils;
